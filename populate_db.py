...
def calculate_graph_data(n):
    ...
    # For n > 6150, we'll just store "0" for all the list data
    if n > 6150:
        ...
        # For n <= 6150, use the original logic (though you won't hit this in practice)
        # ... your original calculation logic here ...
        # (I'll include a simplified version for completeness)
...
if __name__ == "__main__":
    ...
    populate_database(start_n, end_n)